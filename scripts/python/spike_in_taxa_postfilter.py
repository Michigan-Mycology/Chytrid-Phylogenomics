...
ddict = {}
print(sheet)
for filt_fname in [x for x in os.listdir(args.filt_unaln) if x.endswith(".fasta")]:
    d = {}
...
was_it_spiked = pd.DataFrame(ddict)
was_it_spiked.to_csv("was_it_spiked.tsv", sep="\t")
