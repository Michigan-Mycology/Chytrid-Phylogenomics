...
while read p; do
	...
	python ~/work/Chytrid-Phylogenomics/ploidy/scripts/vcf_to_af.py --strain ${strain} -c ${L50HEADERS}/${asm}.${L50HEADERSUFF} --skip_na_mqrs --dpfilt --mqrsfilt --position ${GVCFS}/${strain}.${VCFSUFF}
done < $DATATABLE
